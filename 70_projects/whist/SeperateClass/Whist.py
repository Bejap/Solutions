...
class Whist:
    ...
    def __play_round(self, ):
        ...
        winning_score = self.team_scores[winning_team]
        print(f"\nTeam {winning_team + 1} wins the round with a score of {winning_score - 6}!")

        return winning_score

    def play_game(self):
        # Choose trump for each game cycle
        for game_number in range(5):  # Play up to 5 games
