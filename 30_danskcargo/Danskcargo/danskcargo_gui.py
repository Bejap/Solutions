...
pady = 4
rowheight = 24
treview_background = "#eeeeee"
treview_foreground = "black"
...
main_window = tk.Tk()
main_window.title("AspiIT S2: Danskcargo")
main_window.geometry("1200x500")

style = ttk.Style()
style.theme_use("default")

style.configure("Treeview", background=treview_background, foreground=treview_foreground, rowheight=rowheight, fieldbackground=treview_background)
...
tree_container.column("id", anchor=tk.E, width=30)
...
tree_aircraft.column("id", anchor=tk.E, width=30)
...
label_aircraft_max_cargoweight = tk.Label(edit_frame_aircraft, text="Max Weight")
label_aircraft_max_cargoweight.grid(row=0, column=1, padx=padx, pady=pady)
...
tree_transport.column("id", anchor=tk.E, width=30)
tree_transport.column("date", anchor=tk.E, width=180)
tree_transport.column("container_id", anchor=tk.W, width=30)
tree_transport.column("aircraft_id", anchor=tk.W, width=30)
...
entry_transport_date = tk.Entry(edit_frame_transport, width=16, justify="right")
entry_transport_date.grid(row=1, column=1, padx=padx, pady=pady)

label_transport_container_id = tk.Label(edit_frame_transport, text="Container_id")
...
label_transport_aircraft_id = tk.Label(edit_frame_transport, text="Aircraft_id")
